 ...
 *
 * ```js
 *   HemgageDev = angular.module('HemgageDev', ['Hemgage', 'ngMockE2E']);
 *   HemgageDev.run(function($httpBackend) {
...
!(function(jasmineOrMocha) {
   ...
   * ```js
   *
   *   angular.module('HemgagelicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('Hemgage', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('HemgagelicationModule'));
   *
   *
